...
public class LocationManagersRRDto {
	...
	private List<ResourceItemDto> rrList;
	...
	public List<ResourceItemDto> getRrList() {
		return rrList;
	}

	public void setRrList(List<ResourceItemDto> rrList) {
		this.rrList = rrList;
	}
