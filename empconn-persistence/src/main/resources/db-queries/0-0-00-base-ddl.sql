CREATE TABLE cranium.department (
...
CREATE TABLE cranium.business_unit (
                ...
                modified_by BIGINT,
                is_active BOOLEAN DEFAULT true NOT NULL,
                CONSTRAINT business_unit_pk PRIMARY KEY (business_unit_id)
);


CREATE TABLE cranium.email_configuration (
                email_configuration_id SMALLINT NOT NULL,
                name VARCHAR NOT NULL,
                to_mail_ids VARCHAR,
                cc_mail_ids VARCHAR,
                append_mail_ids BOOLEAN DEFAULT true NOT NULL,
                created_on TIMESTAMP NOT NULL,
                created_by BIGINT NOT NULL,
                modified_on TIMESTAMP,
                modified_by BIGINT,
                is_active VARCHAR DEFAULT true NOT NULL,
                CONSTRAINT email_configuration_pk PRIMARY KEY (email_configuration_id)
);
...
ALTER TABLE cranium.employee ADD CONSTRAINT department_employee_fk
FOREIGN KEY (department_id)
REFERENCES cranium.department (department_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE cranium.employee ADD CONSTRAINT division_employee_fk
FOREIGN KEY (division_id)
REFERENCES cranium.division (division_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE cranium.employee ADD CONSTRAINT business_unit_employee_fk
FOREIGN KEY (business_unit_id)
REFERENCES cranium.business_unit (business_unit_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE cranium.allocation ALTER COLUMN release_date type date;

ALTER TABLE cranium.allocation ALTER COLUMN deallocated_on type date;